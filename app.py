...
class QRSimulator:
    """Clase para simular la lectura de códigos QR para productos lácteos"""

    # PRODUCTOS CORREGIDOS PARA FÁBRICA LÁCTEA - CAJAS DE LECHE DE 6 UNIDADES
    PRODUCTOS = [
    ...
    @staticmethod
    def generar_qr():
        """Simula la lectura de un código QR con formato CSV para productos lácteos"""
